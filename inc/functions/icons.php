...
add_action( 'wp_footer', 'baltic_include_svg_icons', 9999 );
 ...
 */
function baltic_get_svg( $args = array() ) {
	 ...
	 *
	 * Example 1 with title: <?php echo baltic_get_svg( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ) ) ); ?>
	 *
	 * Example 2 with title and description: <?php echo baltic_get_svg( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ), 'desc' => __( 'This is the description', 'textdomain' ) ) ); ?>
	 *
 ...
 */
function baltic_nav_menu_social_icons( $item_output, $item, $depth, $args ) {
...
add_filter( 'walker_nav_menu_start_el', 'baltic_nav_menu_social_icons', 10, 4 );
 ...
 */
function baltic_dropdown_icon_to_menu_link( $title, $item, $args, $depth ) {

	$dropdown_menu = baltic_get_svg( array( 'class' => 'icon-stroke icon-dropdown', 'icon' => 'chevron-bottom' ) );
