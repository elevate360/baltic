...
function baltic_demo_import() {
    ...
    $import = array(
        array(
            ...
            'import_preview_image_url'   => 'https://cdn.rawgit.com/elevate360/Pacific/master/screenshot.jpg',
        ...
        array(
            ...
            'import_preview_image_url'   => 'https://cdn.rawgit.com/elevate360/Atlantic/master/screenshot.jpg',
            'import_notice'              => __( 'After you import this demo, you will have to setup the slider separately.', 'baltic' ),
        ...
        array(
            ...
            'import_preview_image_url'   => 'https://cdn.rawgit.com/elevate360/Caspian/master/screenshot.jpg',
            'import_notice'              => __( 'After you import this demo, you will have to setup the slider separately.', 'baltic' ),
