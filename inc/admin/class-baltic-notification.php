		...
		?>
			<div class="notice baltic-notice is-dismissible">
				...
				<div class="baltic-notice-content">
					<h2><?php echo sprintf( esc_attr__( '%s theme successfully installed.', 'baltic' ), BALTIC_THEME_NAME ); ?></h2>
					<p><?php echo sprintf( esc_attr__( 'Thank you for choosing %s theme! To take full advantage of our theme can offer, please make sure you visit our welcome page.', 'baltic' ), BALTIC_THEME_NAME ); ?></p>
					<p><a href="<?php echo self_admin_url( 'themes.php?page=baltic' ) ;?>" class="button button-primary button-hero"><?php esc_attr_e( 'Get Started with Baltic', 'baltic' );?></a></p>
				</div>
				<?php endif;?>
			</div>
		<?php
