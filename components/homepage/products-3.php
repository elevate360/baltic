...
$columns 	= get_theme_mod( 'baltic_homepage_products_3_columns', 4 );
$orderby 	= get_theme_mod( 'baltic_homepage_products_3_orderby', 'date' );
$order 		= get_theme_mod( 'baltic_homepage_products_3_order', 'ASC' );
$visibility = get_theme_mod( 'baltic_homepage_products_3_visibility', 'ASC' );
$status = get_theme_mod( 'baltic_homepage_products_3_status' );
$status = ( !empty( $status ) ) ? ' ' . $status . '="true"' : '';
$category = (array) get_theme_mod( 'baltic_homepage_products_3_categories' );
...
</div><!-- #baltic-homepage-products-3 -->
